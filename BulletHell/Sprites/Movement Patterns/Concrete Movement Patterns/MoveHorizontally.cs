namespace BulletHellShootingGame.Sprites.Movement_Patterns.Concrete_Movement_Patterns
{
    using System.Timers;
    using Microsoft.Xna.Framework;

    internal class MoveHorizontally : MovementPattern
    {
        ...
        private Timer timer = new Timer(30000); // timer for exit at 30000 mili seconds

        public MoveHorizontally(Vector2 spawnPosition, Vector2 startPosition, Vector2 endPosition, int speed)
            : base()
        {
